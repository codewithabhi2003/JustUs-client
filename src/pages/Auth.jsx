  ...
  return (
    <div style={{
        ...
        <div style={{ position: 'relative', textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', gap: 20, justifyContent: 'center', marginTop: 36 }}>
            {['💬 Real-time chat', '📞 Voice & video', '🔒 Private & secure'].map(f => (
              <div key={f} style={{ fontSize: 12, color: 'rgba(255,255,255,0.4)', background: 'rgba(255,77,141,0.08)', border: '1px solid rgba(255,77,141,0.15)', borderRadius: 99, padding: '6px 14px' }}>
                {f}
              </div>
            ))}
          </div>
      ...
      <div style={{
        ...
        padding: 48, background: 'var(--bg-surface)',
      }}>
